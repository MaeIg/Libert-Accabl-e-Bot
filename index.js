...
const asw = {
	...
	actualité: ['Google est ton ami !', 'La méta a 10 ans !', 'Vive Maelgie !', 'Charpi s\'est marié !'],
	...
	penis: ['8=D'],
	film: ["You shit on my garden ?!", "Ils sont entrain de manger ma maman" + ssadcat, "Don't piss on the hospitality", "Vous êtes un koala tout à fait décent", "La rivière de nos larmes coule après le koala", "Beaux yeux belles couilles", "Ils sont bons qu'a sucer des bites et des carottes"],
	license: ['https://github.com/MaeIg/Libert-Accabl-e-Bot/blob/master/LICENSE.md'],
	Bernard: ['C\'est moi !'],
	Maelg: ['Miou !', "J'aime pas Despacito, je l'ai juste jouée 50 fois sur osu!", ":3", "Ma copine c'est encore pire elle peut les écarter à fond", "En vrai jsuis sûr que j'aimerais bien la soupe de bienvenue", "Pourquoi tout ce qui tourne autour de Supken est d'une débilité incommensurable ?", "Wesh c'est mon île pas un logement social", "Honnêtement la seule fois où j'ai fait une tourte aux blettes c'était super bon. On sentait pas le goût des blettes et que le goût des pommes et j'ai adoré."],
	Cleme: ['Et c\'est sur ces mots que toute envie révolutionnaire s\'éteint chez le peuple.','Le mandat de la présidente Cleme était incontestable et sa puissance sans limite.', "Île-de-France? Tu veux dire Paris", "Y a que Paint de vrai", chanBeauf, "CLIQUE SUR LES CHARIOTS SALE CON", "Tant mieux qu'elle soit morte ils devraient tous mourir ces sales americains du Sud", "Vous avez qu'à faire des requêtes plutôt que raler que c'est pas à jour", "T'es vraiment bête c'est ouf n'empêche"],
	...
	Alexis: ["On a déjà vomi dans mon duvet et dans mes oreilles c'était vraiment pas super " + ssadcat, "Voulez vous écouter \"on va niquer ce soir\" ?", "TU CROIS QUE TU COMPRENDS PAS MAIS EN FAIT TU COMPRENDS PAS ENCORE MOINS", "Il faudrait un wiki-dramas", "moi ce que j'aime c'est faire mes réductions polynomiales entre problèmes np-complets tout seul dans mon coin", "Bon j'ai affuté un couteau, j'ai rasé ma jambe, mais mes poils sont pas photogéniques alors c'est surement toi qui a la plus grosse  :calim:"],
	Mad: ["Personne ira visiter ton île.", shumpf],
	Glen: ["Oui ne met pas ça dans ton vagin ! C'est des boules de méditation ça !"],
	Yaken: ["Mon copain a promis à sa famille que je ferais un aligot demain (pour 7 personnes), la prochaine fois, rappelez moi que le célibat c'est pas si mal", "#putainlesbarsontrouvertgtrppbu"],
	Symfo: ["J'ai appris à mon fils a appris à dire \"bouboule\" quand il parle de ses bourses ... du coups il le dit tout le temps ...", "Semaine derniere (je crois) il a dû m'entendre dire \"on en a rien à foutre\", du coup il disait \"foutre foutre foutre foutre\" à la nounou"]
};
const helpInfo = {
